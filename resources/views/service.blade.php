...
<html>
  <head>
    ...
    <title>OUR SERVICES | Welcome</title>
  ...
  <body>
    <header>
        <div class="container">
          <div id="branding">
            <h1><span class="highlight">BUS</span> INDEX</h1>
          </div>
          <nav>
            <ul>
...
Their website has a good feature of scrolling updates from different bus operators live, so that you don’t stay uninformed of any important news regarding schedules. </p>
    ...
    <footer>
      <p>BD BUS SERVICE, Copyright &copy; 2020</p>
    </footer>
  </body>
</html>
